...
public class BaiduOpenAPIDemo extends ListActivity {
	...
	private void initIntent(){
		...
		String[] openAPI = getResources().getStringArray(R.array.openAPIArray);
		
		Context appCtx = getApplicationContext();
		
		Intent i = new Intent();
		i.setClass(appCtx, OAuthAPIDemo.class);
		intentMap.put(openAPI[0], i);
		
		i = new Intent();
		i.setClass(appCtx, MapAPIDemo.class);
